...
## This script submits the job for 02_feature_selection_all_stepwise.R
## it creates 18 array jobs, running feature selection for each outcome

#SBATCH --partition=compute
#SBATCH --job-name=StepwiseTop20
...
R_CONTAINER='<path>'
R_SCRIPT='<path>/02_feature_selection_all_stepwise.R'
BIND_DIR="<path>,<path>"
