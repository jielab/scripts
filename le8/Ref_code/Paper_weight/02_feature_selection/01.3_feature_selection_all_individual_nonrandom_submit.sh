...
## This script submits the job for 02.3_feature_selection_all_individual_nonrandom.R
## it creates 18 array jobs, running feature selection for each outcome

#SBATCH --partition=compute
#SBATCH --job-name=IndividualDomainNonRandom
...
R_CONTAINER='<path>'
R_SCRIPT='<path>/02.3_feature_selection_all_individual_nonrandom.R'
BIND_DIR="<path>,<path>"
