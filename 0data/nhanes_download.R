...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# NHANES_download_v2.R
# Batch download NHANES XPT files needed for MAHA vs DASH/MIND/MEDI validation.
# Compared with the earlier version, this adds DR1IFF/DR2IFF/DRXFCD food-level files
# and linked mortality files. The folder structure remains: D:/data/nhanes/raw/<cycle>/<component>/.
...
# Set only_maha = FALSE to keep your earlier broader common-table download.
