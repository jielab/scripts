...
usage() {
  cat <<'USAGE'
Usage:
  ./charles_unzip.sh [options]
  ./charles_unzip.sh -h

Options:
  --raw-dir DIR          Archive root. Default: /mnt/d/data/charls/raw
  --clean-dir DIR        Extraction root. Default: /mnt/d/data/charls/clean
