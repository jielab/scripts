#!/usr/bin/env python3
"""
Download UKB proteomics GWAS files from Synapse.

Typical PROT European discovery run:
  python f/ppp_download.py \
    --out /mnt/d/data.BIG/gwas/prot/.project/download \
    --folder syn51365303 \
    --name-regex '\\.tar$' \
...
Authentication:
  export SYNAPSE_AUTH_TOKEN="$(tr -d '\\r\\n' < /mnt/d/data/ukb/prot/authToken.txt)"
"""
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--out", default="/mnt/d/data.BIG/gwas/prot/.project/download", help="Staging output directory")
...
# 🚩 Synapse discovery and sessions
