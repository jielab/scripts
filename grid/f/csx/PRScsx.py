...
def main():
    ...
    # Keep all population-specific outputs together. mcmc_gtb writes posterior
    # effects as <POP>/<POP>.chr<CHR>.pst_eff.txt.
    for population in param_dict['pop']:
        os.makedirs(os.path.join(param_dict['out_dir'], population), exist_ok=True)
