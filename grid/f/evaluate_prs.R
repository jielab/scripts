...
# -----------------------------------------------------------------------------
# Analysis 2: DiscoDivas paper design: fixed 1,300-person fine-tuning cohorts,
# remaining participants used for testing; OTH conventional model used for OTH/AMR.
# -----------------------------------------------------------------------------
...
# Full-data deployment model. Performance claims remain based on held-out analyses.
