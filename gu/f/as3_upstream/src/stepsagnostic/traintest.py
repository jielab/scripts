...
def inference_and_write(base_model, smoother_model, test_loader,
    ...
    with torch.no_grad():
        ...
        for i, batch in progress_bar:
            ...
            if not seg_df_raw.empty:
                ...
                final_bed_df_raw['sample_hap_id'] = final_bed_df_raw['sample_hap_id'].fillna('Unknown_HapID')
    ...
    if is_first_chunk or not os.path.isfile(raw_snps_path):
        ...
        try:
            ...
            # Gzip permits concatenated members. Appending a headerless member
            # keeps normal gzip readers compatible and avoids decompressing and
            # rewriting every prior sample chunk (quadratic I/O and memory).
            with gzip.open(raw_snps_path, 'at', encoding='utf-8') as f:
