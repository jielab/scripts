...
# - Use self-contained b37/b38 chrX PAR/non-PAR coordinates.
# - Re-bgzip Chagyr files in the Chagyr directory, not the unrelated current directory.
set -euo pipefail

dir0=${dir0:-/mnt/d}; dir_ref=${dir_ref:-$dir0/data.BIG/refGen}
script_dir=$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" && pwd)
# 1-based inclusive coordinates for bcftools -r. PLINK2 --split-par uses b37/b38 aliases.
X_PAR_b37="X:60001-2699520,X:154931044-155260560"
X_NONPAR_b37="X:2699521-154931043"
X_PAR_b38="X:10001-2781479,X:155701383-156030895"
X_NONPAR_b38="X:2781480-155701382"
...
modern_root=${MODERN_ROOT:-$PWD}; archaic_root=${ARCHAIC_ROOT:-$dir_ref/archaic/GRCH$GRCH/avcf}
