...
0. ``region_scan`` (written by phyml_region_scan.py): every regional modern
...
def prepare(args: argparse.Namespace) -> None:
    ...
    region_segment_rows = read_tsv(out / "final" / "region_match_segments.unfiltered.tsv")
    region_family_rows = read_tsv(out / "final" / "region_candidate_families.unfiltered.tsv")
    region_locus_rows = final_rows_by_locus(out, "region_scan_loci.unfiltered.tsv")
    ...
    params = {
        ...
        "regional_stage1_files": {
            "all_haplotypes": "region_haplotypes.unfiltered.tsv",
            "all_haplotype_reference_pairs": "region_matches.unfiltered.tsv",
            "local_segments": "region_match_segments.unfiltered.tsv",
            "families": "region_candidate_families.unfiltered.tsv",
        },
