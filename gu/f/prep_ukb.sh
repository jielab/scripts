...
HAP=${UKB_HAP_ROOT:-/mnt/h/ukbGen/37/hap}
TYPED=${UKB_TYPED_ROOT:-/mnt/h/ukbGen/37/typ}
...
Minimal chr22 preparation:
  ./gu.sh ukb inspect-hap --chr 22 --grch 37 --ukb-hap-root /mnt/h/ukbGen/37/hap
  ./gu.sh ukb make-panel --chr 22 --grch 37 --ukb-hap-root /mnt/h/ukbGen/37/hap
  ...
  ./gu.sh ukb hap-arg-vcf --chr 22 --grch 37 --ukb-hap-root /mnt/h/ukbGen/37/hap --ukb-ref-fasta /path/to/human_g1k_v37.fasta --ukb-keep /mnt/d/analysis/gu/ukb/batches/ALL.b0001.joint.txt --ukb-1kg-vcf-dir /mnt/d/data.BIG/refGen/1kg/37/vcf --ukb-vcf-out /mnt/d/analysis/gu/ukb/work/ALL.b0001/vcf --ukb-arg-vcf-out /mnt/d/analysis/gu/ukb/work/ALL.b0001/vcf.aa
HELP
}
...
PY
  ...
  hap-arg-vcf)
    ...
    echo "Next: bash /mnt/d/scripts/gu/arg.sh build --method tsinfer --dir-gen ${GU_TARGET_ROOT:-/mnt/h/ukbGen/37} --dir-vcf $AAOUT --chr $CHRS --grch ${GU_BUILD:-37}"
    ;;
