...
for required in phyml.py phyml_core.py phyml_tree_summary.py phyml_region_scan.py phyml_evidence.py phyml_anchor.py phyml_layered_plot.py phyml.tree_plot.R; do
